# AccoWin versie 1.2.0.5 Handleiding voor elektronische aangiften via Intervat
...
3. Bestand klaarmaken
   1. Basisgegevens
   2. Aangiften selecteren
   3. Bestand aanmaken
4. Aangifte indienen via Intervat
   1. Naar website Intervat gaan
   2. Aanmelden
   3. Bestand selecteren
   4. Bestand valideren
   5. Bestand handtekenen
   6. Bevestigen om door te sturen ofwel annuleren
   7. Ontvangstbewijs downloaden in PDF-formaat of XML-formaat

# Elektronische BTW-aangiften via Intervat
...
- Na het invullen van de basisgegevens klikt u op de knop <!-- ![Image 5]() -->. AccoWin zal dan alle dossiers met aangiften voor de geselecteerde periode genereren. Dit proces kan even duren. In de tijdsbalk onderaan het scherm kunt u de vooruitgang van deze zoekactie volgen.
...
- In het scherm wordt weergegeven waar u het bestand kunt vinden.
...
✅ AccoWin/Intervat: HandleidingIntervatNL.pdf
✅ 1309 words
✅ +1641 over from previous 2 orders

📌 I don't know if I should start a new order here or add onto the last  one.
📌 Something is wrong with Images 4 and 5 - I can't save them. Or image 5 is actually a part of image 4. Was the "2nd" image meant to be displayed in the list item below it? That list item has the text "Na het invullen van de basisgegevens klikt u op de knop". I named that file Image4-5.png
