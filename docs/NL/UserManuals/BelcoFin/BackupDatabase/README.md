...
✅ https://support.corpgroup.site/nl/support/solutions/articles/101000171535
✅ 1265 words
✅ BASIC package is $15 for max of 1600 words

📌 This is the first page that has a proper H1 tag so the headings will change as a result
📌 I had to use an img tag for the Windows icon to set the width to 41px because it was too large without that property
📌 Under "Configuratie van Programma starten:" is a ordered list with lowercase ordering and the ordering goes a-b-a. I set it to numbers instead - actually, the numbering in this section is all over the place. This will need to be addressed later
