# <ins>Data importeren in Belcofin</ins>
...
✅ Belcofin/ImportData: https://support.corpgroup.site/nl/support/solutions/articles/101000241282
✅ 3867 words
✅ 7400 - 3867 = 3533 left (1453 over from previous order); 3533 - 1453 = 2080 left

📌 I'm giving up on using proper headings - this file has multiple H1 elements.
📌 File path potential issue:
    1) There have been other files with file paths like c:\kluwerdata\FinFisc\...
    Note that in the markdown files the back slashes are escaped, so \ in markdown is \\
    2) This is the first time I caught what looks like an XML element: <jaartal>
    I've used the html entities &lt; for < and &gt; for > or else those values do not even show. I'll have to go back and check the html pages to make sure I haven't missed any in file paths; I caught all of them in the tables thus far
📌
